				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="课程编号" prop="kechengbianhao">
							<el-input class="list_inp" v-model="form.kechengbianhao" :readonly="true" placeholder="课程编号" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="上课时间" prop="shangkeshijian">
							<el-input class="list_inp" v-model="form.shangkeshijian" placeholder="上课时间"
								 type="text" 								:readonly="!isAdd||disabledForm.shangkeshijian?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="教学地点" prop="jiaoxuedidian">
							<el-input class="list_inp" v-model="form.jiaoxuedidian" placeholder="教学地点"
								 type="text" 								:readonly="!isAdd||disabledForm.jiaoxuedidian?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='kechengbianhao'){
					form.value.kechengbianhao = row[x];
					disabledForm.value.kechengbianhao = true;
					continue;
				}
				...
				if(x=='jiaoxuedidian'){
					form.value.jiaoxuedidian = row[x];
					disabledForm.value.jiaoxuedidian = true;
					continue;
				}
				if(x=='tupian'){
